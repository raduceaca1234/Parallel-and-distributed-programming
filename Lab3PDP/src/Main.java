import domain.generationStrategy.ColumnThread;
import domain.generationStrategy.KThread;
import domain.generationStrategy.MatrixThread;
import domain.generationStrategy.RowThread;
...
public class Main {
    private static final int rowsA = 10;
    private static final int colsA = 10;
    private static final int rowsB = 10;
    private static final int colsB = 10;
...
//                new ThreadPoolExecutor(NUMBER_OF_THREADS, NUMBER_OF_THREADS, 0L, TimeUnit.MILLISECONDS,
...
//                                NUMBER_OF_THREADS, true)); // Executors.newFixedThreadPool(NUMBER_OF_THREADS);
    ...
    private static MatrixThread createKthThread (int index, Matrix matrixA, Matrix matrixB, Matrix matrixC) {
    ...
    private static MatrixThread createColumnThread (int index, Matrix matrixA, Matrix matrixB, Matrix matrixC) {
        int numberOfElementsInMatrix = matrixC.rows * matrixC.columns;
        int setSize = numberOfElementsInMatrix / NUMBER_OF_THREADS;
    ...
    private static MatrixThread createRowThread (int index, Matrix matrixA, Matrix matrixB, Matrix matrixC) {
        int numberOfElementsInMatrix = matrixC.rows * matrixC.columns;
        int setSize = numberOfElementsInMatrix / NUMBER_OF_THREADS;
        if (index == NUMBER_OF_THREADS - 1) setSize += numberOfElementsInMatrix % NUMBER_OF_THREADS;
        int startingLine = setSize * index / matrixC.rows;
